              ...
              <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
                  ...
                  <div className="text-center space-y-2 sm:space-y-3">
                    ...
                    <div className="inline-block bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl shadow-lg">
                      <p className="text-lg sm:text-xl font-bold">{jobTitle}</p>
                    </div>
